...
create table user (id bigint not null auto_increment, age integer, password varchar(255), salary bigint, username varchar(255),balance decimal(10,2), primary key (id)) engine=MyISAM;
